...
namespace admin
{
    public partial class haberresimekle : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                if (uzanti == ".gif" | uzanti == ".jpg" | uzanti == ".bmp" | uzanti == ".png")
                {
                    ...
                    MySqlCommand komut = new MySqlCommand("INSERT INTO newsimage(katid,baslik,resim,sira) VALUES(@katid,@baslik,@resim,@sira)", baglanti);
                    ...
                    komut.Parameters.AddWithValue("@personelid", Session["Id"]); komut.Parameters.AddWithValue("@ipadres", HttpContext.Current.Request.UserHostAddress); komut.Parameters.AddWithValue("@bagzamani", tarih); komut.Parameters.AddWithValue("@durum", "Haber Resim Ekledi");
            ...
            {
                MySqlConnection baglanti = new MySqlConnection(ConfigurationManager.AppSettings["Baglanti"]); baglanti.Open();
                MySqlCommand komut = new MySqlCommand("INSERT INTO newsimage(katid,baslik,sira) VALUES(@katid,@baslik,@sira)", baglanti);
                komut.Parameters.AddWithValue("@katid", Request.QueryString["Id"]); komut.Parameters.AddWithValue("@baslik", TextBox1.Text);
                komut.Parameters.AddWithValue("@sira", TextBox2.Text);
                komut.ExecuteNonQuery(); komut.CommandText = "INSERT INTO logs(personelid,ipadres,bagzamani,durum) VALUES(@personelid,@ipadres,@bagzamani,@durum)"; komut.Dispose();
                komut.Parameters.AddWithValue("@personelid", Session["Id"]); komut.Parameters.AddWithValue("@ipadres", HttpContext.Current.Request.UserHostAddress); komut.Parameters.AddWithValue("@bagzamani", tarih); komut.Parameters.AddWithValue("@durum", "Habere Resimsiz Resim Bilgisi Ekledi");
