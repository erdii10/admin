    ...
    public partial class haberler : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["Id"] != null)
            {
                ...
                MySqlDataAdapter da = new MySqlDataAdapter("Select Id,katid,sira,baslik,baslikEN from news Where katid='0' order by sira", baglanti); DataTable dt = new DataTable();
