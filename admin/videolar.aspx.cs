    ...
    public partial class videolar : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["Id"] != null)
            {
                ...
                MySqlDataAdapter da = new MySqlDataAdapter("Select Id,katId,sira,baslik,baslikEN from video Where katId='0' order by sira", baglanti); DataTable dt = new DataTable();
