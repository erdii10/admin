...
namespace admin
{
    public partial class icerikdosyaduzenle : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["Id"] != null)
            {
                ...
                MySqlDataAdapter da = new MySqlDataAdapter("Select katid,baslik,aciklama,yolu,turu,sira from contentsfile Where Id='" + Request.QueryString["Id"] + "'", baglanti);
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    /*Ana Başlıklar*/
                    da.SelectCommand.CommandText = "Select * from contentsfile Where Id='" + Request.QueryString["Id"] + "' order by sira"; dt.Dispose();
                    ...
                    /*Alt Başlıklar*/
                    da.SelectCommand.CommandText = "Select * from contentsfile Where Id='" + Request.QueryString["Id"] + "'"; dt.Dispose();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (FileUpload1.HasFile)
            {
                ...
                if (dosyaboyutu < 5000000)
                {
                    if (dosyaboyutu < 1048576)
                    {
                        ...
                        MySqlConnection baglanti = new MySqlConnection(ConfigurationManager.AppSettings["Baglanti"]); baglanti.Open();
                        MySqlCommand komut = new MySqlCommand("Update contentsfile Set baslik=@baslik,aciklama=@aciklama,yolu=@yolu,turu=@turu,boyutu=@boyutu,sira=@sira Where Id='" + Request.QueryString["Id"] + "'", baglanti);
                        ...
                        komut.Parameters.AddWithValue("@personelid", Session["Id"]); komut.Parameters.AddWithValue("@ipadres", HttpContext.Current.Request.UserHostAddress); komut.Parameters.AddWithValue("@bagzamani", DateTime.Now.ToString()); komut.Parameters.AddWithValue("@durum", "İçerik Dosya Güncelledi");
            ...
            else
            {
                ...
                MySqlConnection baglanti = new MySqlConnection(ConfigurationManager.AppSettings["Baglanti"]); baglanti.Open();
                MySqlCommand komut = new MySqlCommand("Update contentsfile Set baslik=@baslik,aciklama=@aciklama,sira=@sira Where Id='" + Request.QueryString["Id"] + "'", baglanti);
                ...
                komut.ExecuteNonQuery(); komut.CommandText = "Insert into logs(personelid,ipadres,bagzamani,durum) Values(@personelid,@ipadres,@bagzamani,@durum)"; komut.Dispose();
                komut.Parameters.AddWithValue("@personelid", Session["Id"]); komut.Parameters.AddWithValue("@ipadres", HttpContext.Current.Request.UserHostAddress); komut.Parameters.AddWithValue("@bagzamani", DateTime.Now.ToString()); komut.Parameters.AddWithValue("@durum", "İçerik Dosya İçeriği Güncelledi");
                komut.ExecuteNonQuery(); komut.Dispose(); baglanti.Close(); Response.Redirect("icerikduzenle.aspx?Id=" + katid);
            }
        }
    }
