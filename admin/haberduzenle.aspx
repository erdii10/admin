<%@ Page Title="" Language="C#" MasterPageFile="~/Skin.Master" AutoEventWireup="true" validateRequest="false" CodeBehind="haberduzenle.aspx.cs" Inherits="admin.haberduzenle" %>
...
<div class="Kenar">
    ...
    <div class="IcerikTaban">
        <asp:Panel ID="Panel1" runat="server">
            ...
            <div id="AltIcerikUst">
                <div style="float:left;">Kategoriye Ait Haberler</div>
                <div style="float:right;"><a href="haberekle.aspx?Id=<%=Id %>"><img src="/images/ekle.jpg" border="0" /></a></div>
                <div class="Temizle"></div>
            </div>
            <%if (kontrol == "var"){%>
            <div id="IcerikUst" style="margin-top:20px;">
                <div style="float:left; width:5%;">Sıra</div>
                <div style="float:left; width:91%;">Kategori Adı</div>
            ...
            <div class="IcerikVeri">
                ...
                <div style="float:left; width:2%;"><a href="sil.aspx?Id=<%#DataBinder.Eval(Container.DataItem,"Id") %>&kategori=Haber"><img src="/images/sil.jpg" border="0" /></a></div>
                <div class="Temizle"></div>
            </div>
        ...
        <asp:Panel ID="Panel2" runat="server">
            ...
            <div id="AltIcerikUst">
                <div style="float:left;">Habere Ait Resimler</div>
                <div style="float:right;"><a href="haberresimekle.aspx?Id=<%=Id %>&kategori=HaberResimEkle"><img src="/images/ekle.jpg" border="0" /></a></div>
                <div class="Temizle"></div>
            </div>
            <%if (kontrolresim == "var"){%>
            <div style="margin-top:20px; width:100%;">
                ...
                <div class="IcerikImgBg">
                    <div class="ResimBg"><img src="/img/news/<%#DataBinder.Eval(Container.DataItem,"resim")%>" width="100%" height="100%" border="0" /></div>
                    <div class="ResimText">
                        ...
                        <div style="margin-top:5px;">
                            <div style="float:left; margin:5px; margin-left:0px;"><a href="haberresimduzenle.aspx?Id=<%#DataBinder.Eval(Container.DataItem,"Id") %>&kategori=HaberResimDuzenle"><img src="/images/duzenle.jpg" border="0" /></a></div>
                            <div style="float:left; margin:5px; margin-left:0px;"><a href="sil.aspx?Id=<%#DataBinder.Eval(Container.DataItem,"Id") %>&kategori=HaberResim"><img src="/images/sil.jpg" border="0" /></a></div>
                            <div class="Temizle"></div>
                        </div>
                    </div>
                    <div class="Temizle"></div>
            ...
            <%} %>
            <div id="AltIcerikUst">
                <div style="float:left;">Habere Ait Dosyalar</div>
                <div style="float:right;"><a href="haberdosyaekle.aspx?Id=<%=Id %>"><img src="/images/ekle.jpg" border="0" /></a></div>
                <div class="Temizle"></div>
            </div>
            <%if (kontroldosya == "var"){%>
            <div id="IcerikUst" style="margin-top:20px;">
            ...
            <div class="IcerikVeri">
                ...
                <div style="float:left; width:2%;"><a href="haberdosyaduzenle.aspx?Id=<%#DataBinder.Eval(Container.DataItem,"Id") %>"><img src="/images/duzenle.jpg" border="0" /></a></div>
                <div style="float:left; width:2%;"><a href="sil.aspx?Id=<%#DataBinder.Eval(Container.DataItem,"Id") %>&kategori=HaberDosya"><img src="/images/sil.jpg" border="0" /></a></div>
                <div class="Temizle"></div>
            </div>
            </ItemTemplate></asp:Repeater>
            <div style="margin-top:10px;" align="center">
