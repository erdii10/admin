...
namespace admin
{
    public partial class haberdosyaekle : System.Web.UI.Page
    {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                if (dosyaboyutu < 5000000)
                {
                    if (dosyaboyutu < 1048576)
                    {
                        ...
                        MySqlCommand komut = new MySqlCommand("INSERT INTO newsfile(katid,baslik,aciklama,yolu,turu,boyutu,sira) VALUES(@katid,@baslik,@aciklama,@yolu,@turu,@boyutu,@sira)", baglanti);
                        ...
                        komut.Parameters.AddWithValue("@personelid", Session["Id"]); komut.Parameters.AddWithValue("@ipadres", HttpContext.Current.Request.UserHostAddress); komut.Parameters.AddWithValue("@bagzamani", DateTime.Now.ToString()); komut.Parameters.AddWithValue("@durum", "Habere Dosya Ekledi");
                        komut.ExecuteNonQuery(); komut.Dispose(); baglanti.Close(); Response.Redirect("haberduzenle.aspx?Id=" + Request.QueryString["Id"].ToString());
                    }
