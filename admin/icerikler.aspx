<%@ Page Title="" Language="C#" MasterPageFile="~/Skin.Master" AutoEventWireup="true" CodeBehind="icerikler.aspx.cs" Inherits="admin.icerikler" %>
...
<div class="Kenar">
    ...
    <div class="IcerikTaban">
        ...
        <div class="IcerikVeri">
            ...
            <div style="float:left; width:2%;"><a href="sil.aspx?Id=<%#DataBinder.Eval(Container.DataItem,"Id") %>&kategori=IcerikKat"><img src="/images/sil.jpg" border="0" /></a></div>
            <div class="Temizle"></div>
        </div>
