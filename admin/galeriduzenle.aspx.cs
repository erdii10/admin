...
namespace admin
{
    public partial class galeriduzenle : System.Web.UI.Page
    {
        public string Id, kontrolgaleri, resim, kontrolresim, kontrolbaslik, kontrolaltbaslik;
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["Id"] != null)
            {
                ...
                MySqlDataAdapter da = new MySqlDataAdapter("Select katid,baslik,sira,resim from gallery Where Id='" + Request.QueryString["Id"] + "'", baglanti);
                ...
                if (katid == "0")
                {
                    ...
                    if (!Page.IsPostBack)
                    {
                        ...
                        /*Kategoriye Ait Galeri*/
                        da.SelectCommand.CommandText = "Select * from gallery Where katid='" + Request.QueryString["Id"] + "' order by sira"; dt.Dispose();
                        dt = new DataTable(); da.Fill(dt); if (dt.Rows.Count == 0) { kontrolgaleri = "yok"; } else { kontrolgaleri = "var"; }
                ...
                else
                {
                    ...
                    if (!Page.IsPostBack)
                    {
                        da.SelectCommand.CommandText = "Select * from gallery Where Id='" + Request.QueryString["Id"] + "'"; dt.Dispose(); dt = new DataTable(); da.Fill(dt);
                        TextBox3.Text = dt.Rows[0]["baslik"].ToString(); TextBox4.Text = dt.Rows[0]["sira"].ToString();
                        if (dt.Rows[0]["resim"].ToString() == "") { kontrolresim = "yok"; }
                        else { kontrolresim = "var"; resim = dt.Rows[0]["resim"].ToString(); }
                        /*---------------------------------------------------------------------------------------*/
                        /*Ana Başlıklar*/
                        da.SelectCommand.CommandText = "Select * from gallery Where Id='" + Request.QueryString["Id"] + "' order by sira"; dt.Dispose();
                        dt = new DataTable(); da.Fill(dt); if (dt.Rows.Count == 0) { kontrolbaslik = "yok"; }
                        else { kontrolbaslik = "var"; string kate = dt.Rows[0]["katid"].ToString(); da.SelectCommand.CommandText = "Select * from gallery Where Id='" + kate + "'"; dt.Dispose(); dt = new DataTable(); da.Fill(dt); RptBasliklar.DataSource = dt.DefaultView; RptBasliklar.DataBind(); }
                        /*Alt Başlıklar*/
                        da.SelectCommand.CommandText = "Select * from gallery Where Id='" + Request.QueryString["Id"] + "'"; dt.Dispose();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (FileUpload1.HasFile)
            {
                ...
                if (uzanti == ".gif" | uzanti == ".jpg" | uzanti == ".bmp" | uzanti == ".png")
                {
                    ...
                    MySqlConnection baglanti = new MySqlConnection(ConfigurationManager.AppSettings["Baglanti"]); baglanti.Open();
                    MySqlCommand komut = new MySqlCommand("Update gallery Set baslik=@baslik,resim=@resim,sira=@sira,baslikEN=@baslikEN Where Id='" + Request.QueryString["Id"] + "'", baglanti);
                    ...
                    komut.Parameters.AddWithValue("@personelid", Session["Id"]); komut.Parameters.AddWithValue("@ipadres", HttpContext.Current.Request.UserHostAddress); komut.Parameters.AddWithValue("@bagzamani", DateTime.Now.ToString()); komut.Parameters.AddWithValue("@durum", "Galeri Kategori Resimli Düzeltme Yaptı");
                    ...
                    Response.Redirect("kirp.aspx?Id=" + Request.QueryString["Id"] + "&resimadi=" + resimadi + uzanti + "&kategori=GaleriDuzelt");
                }
            ...
            else
            {
                ...
                MySqlConnection baglanti = new MySqlConnection(ConfigurationManager.AppSettings["Baglanti"]); baglanti.Open();
                MySqlCommand komut = new MySqlCommand("Update gallery Set baslik=@baslik,sira=@sira,baslikEN=@baslikEN Where Id='" + Request.QueryString["Id"] + "'", baglanti);
                ...
                komut.ExecuteNonQuery(); komut.CommandText = "Insert into logs(personelid,ipadres,bagzamani,durum) Values(@personelid,@ipadres,@bagzamani,@durum)"; komut.Dispose();
                komut.Parameters.AddWithValue("@personelid", Session["Id"]); komut.Parameters.AddWithValue("@ipadres", HttpContext.Current.Request.UserHostAddress); komut.Parameters.AddWithValue("@bagzamani", DateTime.Now.ToString()); komut.Parameters.AddWithValue("@durum", "Galeri Kategori Resimsiz Düzeltme Yaptı");
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            if (FileUpload2.HasFile)
            {
                ...
                if (uzanti == ".gif" | uzanti == ".jpg" | uzanti == ".bmp" | uzanti == ".png")
                {
                    ...
                    komut.ExecuteNonQuery(); komut.CommandText = "Insert into logs(personelid,ipadres,bagzamani,durum) Values(@personelid,@ipadres,@bagzamani,@durum)"; komut.Dispose();
                    komut.Parameters.AddWithValue("@personelid", Session["Id"]); komut.Parameters.AddWithValue("@ipadres", HttpContext.Current.Request.UserHostAddress); komut.Parameters.AddWithValue("@bagzamani", DateTime.Now.ToString()); komut.Parameters.AddWithValue("@durum", "Galeri Resimli Düzeltme Yaptı");
                    /*Resmi Orginal Boyutta Kaydetme*/
            ...
            else
            {
                ...
                komut.ExecuteNonQuery(); komut.CommandText = "Insert into logs(personelid,ipadres,bagzamani,durum) Values(@personelid,@ipadres,@bagzamani,@durum)"; komut.Dispose();
                komut.Parameters.AddWithValue("@personelid", Session["Id"]); komut.Parameters.AddWithValue("@ipadres", HttpContext.Current.Request.UserHostAddress); komut.Parameters.AddWithValue("@bagzamani", DateTime.Now.ToString()); komut.Parameters.AddWithValue("@durum", "Galeri Resimsiz Düzeltme Yaptı");
                komut.ExecuteNonQuery(); komut.Dispose(); baglanti.Close(); Response.Redirect("galeriduzenle.aspx?Id=" + Request.QueryString["Id"]);
            }
        }
    }
