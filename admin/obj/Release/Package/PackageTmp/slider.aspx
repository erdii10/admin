<%@ Page Title="" Language="C#" MasterPageFile="~/Skin.Master" AutoEventWireup="true" CodeBehind="slider.aspx.cs" Inherits="admin.slider" %>
...
<div class="Kenar">
    ...
    <div class="IcerikTaban">
        <div id="IcerikUst">
            ...
            <div style="float:left; width:11%;">Slider Ekle</div>
        ...
        <div class="IcerikVeri">
            ...
            <div style="float:left; width:10%;"><a href="sliderekle.aspx?Id=<%#DataBinder.Eval(Container.DataItem,"Id") %>" class="IcerikLink">Slider Ekle</a></div>
            ...
            <div style="float:left; width:2%;"><a href="sil.aspx?Id=<%#DataBinder.Eval(Container.DataItem,"Id") %>&kategori=SliderKat"><img src="/images/sil.jpg" border="0" /></a></div>
            <div class="Temizle"></div>
        </div>
