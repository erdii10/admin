<%@ Page Title="" Language="C#" MasterPageFile="~/Skin.Master" AutoEventWireup="true" CodeBehind="eliste.aspx.cs" Inherits="admin.eliste" %>
...
<div class="Kenar">
    ...
    <div id="IcerikTop">
        ...
        <span style="margin-top:5px; position:absolute; left:47%;">Toplam <%=sayi %> E-Posta</span>
    ...
    <div class="IcerikTaban">
        <div id="IcerikUst">
            <div style="float:left; width:5%;">Ad Soyad</div>
            <div style="float:left; width:92.5%;">E-Posta Adresi</div>
            <div style="float:left; width:2%;">İşlem</div>
            <div class="Temizle"></div>
        </div>
        <asp:Repeater ID="RptSirala" runat="server"><ItemTemplate>
        <div class="IcerikVeri">
            <div style="float:left; width:5%;"><%#DataBinder.Eval(Container.DataItem,"adsoyad") %></div>
            <div style="float:left; width:93%;"><%#DataBinder.Eval(Container.DataItem,"eposta") %></div>
            <div style="float:left; width:2%;"><a href="sil.aspx?Id=<%#DataBinder.Eval(Container.DataItem,"Id") %>&kategori=Eliste"><img src="/images/sil.jpg" border="0" /></a></div>
            <div class="Temizle"></div>
        </div>
