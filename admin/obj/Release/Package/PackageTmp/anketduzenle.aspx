<%@ Page Title="" Language="C#" MasterPageFile="~/Skin.Master" AutoEventWireup="true" CodeBehind="anketduzenle.aspx.cs" Inherits="admin.anketduzenle" %>
<%@ Register assembly="CollectionPager" namespace="SiteUtils" tagprefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div class="Kenar">
    <div class="UstBaslik">Anketler <%if (kontrolbaslik == "var"){%><asp:Repeater ID="RptBasliklar" runat="server"><ItemTemplate><span style="font-size:13px;"> > <a href="anketduzenle.aspx?Id=<%#DataBinder.Eval(Container.DataItem,"Id") %>" class="IcerikLink"><%#DataBinder.Eval(Container.DataItem,"baslik") %></a> </span></ItemTemplate></asp:Repeater><% }%><%if (kontrolaltbaslik == "var"){%><asp:Repeater ID="RptAltBasliklar" runat="server"><ItemTemplate><span style="font-size:13px;"> > <a><%#DataBinder.Eval(Container.DataItem,"baslik") %></a> </span></ItemTemplate></asp:Repeater><% }%> </div>
    <div id="IcerikTop">
    ...
    <div class="IcerikTaban">
        <asp:Panel ID="Panel1" runat="server">
            ...
            <div id="AltIcerikUst">
                <div style="float:left;">Ankete Ait Seçenekler</div>
                <div style="float:right;"><a href="anketekle.aspx?Id=<%=Id %>"><img src="/images/ekle.jpg" border="0" /></a></div>
                <div class="Temizle"></div>
            </div>
            <%if (kontrol == "var"){%>
            <div id="IcerikUst" style="margin-top:20px;">
                <div style="float:left; width:5%;">Sıra</div>
                <div style="float:left; width:80%;">Seçenek Adı</div>
                <div style="float:left; width:11%;">Sayaç</div>
            ...
            <div class="IcerikVeri">
                ...
                <div style="float:left; width:10%;"><%#DataBinder.Eval(Container.DataItem,"sayac") %></div>
                <div style="float:left; width:2%;"><a href="anketduzenle.aspx?Id=<%#DataBinder.Eval(Container.DataItem,"Id") %>"><img src="/images/duzenle.jpg" border="0" /></a></div>
                <div style="float:left; width:2%;"><a href="sil.aspx?Id=<%#DataBinder.Eval(Container.DataItem,"Id") %>&kategori=Secenek"><img src="/images/sil.jpg" border="0" /></a></div>
                <div class="Temizle"></div>
            </div>
