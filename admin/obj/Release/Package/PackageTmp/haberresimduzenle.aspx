<%@ Page Title="" Language="C#" MasterPageFile="~/Skin.Master" AutoEventWireup="true" CodeBehind="haberresimduzenle.aspx.cs" Inherits="admin.haberresimduzenle" %>
...
<div class="Kenar">
    ...
    <div class="IcerikTaban">
        ...
        <div style="margin-bottom:10px;">
            ...
            <div style="float:left; padding:5px; margin-right:5px; border:1px solid #CCC;"><img src="/img/news/<%=resim %>" width="355" height="270" border="0" /></div>
