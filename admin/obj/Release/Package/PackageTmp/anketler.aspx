<%@ Page Title="" Language="C#" MasterPageFile="~/Skin.Master" AutoEventWireup="true" CodeBehind="anketler.aspx.cs" Inherits="admin.anketler" %>
...
<div class="Kenar">
    ...
    <div id="IcerikTop">
        ...
        <span style="margin-top:5px; position:absolute; left:47%;">Toplam <%=sayi %> Anket</span>
    ...
    <div class="IcerikTaban">
        <div id="IcerikUst">
            ...
            <div style="float:left; width:81%;">Anket Başlığı</div>
            <div style="float:left; width:10%;">Seçenek Ekle</div>
        ...
        <div class="IcerikVeri">
            ...
            <div style="float:left; width:10%;"><a href="anketekle.aspx?Id=<%#DataBinder.Eval(Container.DataItem,"Id") %>" class="IcerikLink">Seçenek Ekle</a></div>
            ...
            <div style="float:left; width:2%;"><a href="sil.aspx?Id=<%#DataBinder.Eval(Container.DataItem,"Id") %>&kategori=Anket"><img src="/images/sil.jpg" border="0" /></a></div>
            <div class="Temizle"></div>
        </div>
