<%@ Page Title="" Language="C#" MasterPageFile="~/Skin.Master" AutoEventWireup="true" CodeBehind="zaman.aspx.cs" Inherits="admin.zaman" %>
...
<div class="Kenar">
    ...
    <div class="IcerikTaban">
        <div id="IcerikUst">
            ...
            <div style="float:left; width:11%;">Görev Ekle</div>
        ...
        <div class="IcerikVeri">
            ...
            <div style="float:left; width:11%;"><a href="zamanekle.aspx?Id=<%#DataBinder.Eval(Container.DataItem,"Id") %>" class="IcerikLink">Görev Ekle</a></div>
            ...
            <div style="float:left; width:2%;"><a href="sil.aspx?Id=<%#DataBinder.Eval(Container.DataItem,"Id") %>&kategori=ZamanKat"><img src="/images/sil.jpg" border="0" /></a></div>
            <div class="Temizle"></div>
        </div>
